...
if __name__ == '__main__':
    ...
    for ipu in RunPeriod:
        for isys in SystOpt: 
            ...
            #HaddFiles("SingleNeutrino_Flat2016_PreVFP_v2",Study,16)
            #HaddFiles("SingleNeutrino_Flat2016_PostVFP_v2",Study,16)
            if (ipu == "PURunB" or ipu == "PURunC" or ipu == "PURunD" or ipu == "PURunE" or ipu == "PURunF_e"): HaddFiles("SingleNeutrino_Flat2016_PreVFP_v2",Study,16)
            elif (ipu == "PURunF_l" or ipu == "PURunG" or ipu == "PURunH"): HaddFiles("SingleNeutrino_Flat2016_PostVFP_v2",Study,16)
            else : 
                HaddFiles("SingleNeutrino_Flat2016_PreVFP_v2",Study,16)
                HaddFiles("SingleNeutrino_Flat2016_PostVFP_v2",Study,16)
