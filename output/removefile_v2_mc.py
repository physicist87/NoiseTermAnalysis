...
#    RemoveFiles("SingleNeutrino_Flat2017",Study,221)
    ...
    StudyName = "StudySC2018_v5_bk"
    StudyName = "Fix30_2018_v1"
    StudyName = "StudySC2018_v6"
    StudyName = "Fix30_2018_v1p2"
    StudyName = "TestDR04Cut_v1"
    RunPeriod = ["MC"]
    RunPeriod = ["PURunA","PURunB","PURunC","PURunD"]
    SystOpt = ["JECUp","JECDown", "PileUpUp","PileUpDown","Central"]
    SystOpt = ["NoPU"]
    SystOpt = ["Central"]
    for isys in SystOpt: 
        for ipu in RunPeriod:
            ...
            #if ipu == "MC" or ipu == "mc": 
            RemoveFiles("SingleNeutrino_Flat2018",Study,30)
                #RemoveFiles("SingleNeutrino_PreMix2018",Study,216)
