...
if __name__ == '__main__':
    ...
    for isys in SystOpt: 
        ...
        print Study
        RemoveFiles("Data_ZeroBias_Run2018Av2", Study, 56)
        RemoveFiles("Data_ZeroBias_Run2018Bv2", Study, 27)
        RemoveFiles("Data_ZeroBias_Run2018Cv1", Study, 27)
        RemoveFiles("Data_ZeroBias_Run2018Dv1", Study, 126)
