...
LumiReWeighting::LumiReWeighting( std::string generatedFile,
	...
	std::cout << "DataHistName : " << DataHistName << std::endl;
	...
	// normalize both histograms first
        ...
        std::cout << "Before Data_distr_ In tegral : " << Data_distr_->Integral() << std::endl;
        std::cout << "Before MC_distr_ In tegral : " << MC_distr_->Integral() << std::endl;
	Data_distr_->Scale( 1.0/ Data_distr_->Integral() );
	MC_distr_->Scale( 1.0/ MC_distr_->Integral() );
        std::cout << "Data_distr_ In tegral : " << Data_distr_->Integral() << std::endl;
        std::cout << "MC_distr_ In tegral : " << MC_distr_->Integral() << std::endl;
